                        ...
                        {selected && (
                            <div className="space-y-5">
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <Input type="number" value={prixPropose} onChange={(e) => setPrixPropose(e.target.value)} disabled={selected?.status === "TERMINEE"} />                                </div>

                                <div className="grid gap-2">
                                    <Label>Note chef</Label>
                                    <Textarea rows={3} value={noteChef} onChange={(e) => setNoteChef(e.target.value)} disabled={selected?.status === "TERMINEE"} />                                </div>
                            </div>
                        )}

                        <DialogFooter className="gap-2 sm:gap-0">
                            {selected?.status === "TERMINEE" ? (
                                <div className="w-full rounded-xl bg-green-50 p-3 text-sm font-medium text-green-700">
                                    Demande terminée - Commande #{selected.orderId}
                                </div>
                            ) : (
                                <>
                                    <Button
                                    ...
                                    <Button
                                        variant="secondary"
                                        onClick={() => updateStatus("VUE_PAR_CHEF")}
                                        disabled={updateMutation.isPending}
                                    >
                                        Marquer vue
                                    </Button>
                                    ...
                                    <Button
                                        ...
                                        disabled={updateMutation.isPending || !prixPropose}
                                    >
