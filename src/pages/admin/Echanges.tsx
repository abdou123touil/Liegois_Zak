...
export default function Echanges() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast({
        title: "Succès",
        description: "Échange enregistré et ajouté aux dépenses.",
      });
                        ...
                        >
                          <td className="p-4 font-medium text-primary/90">
                            <div className="flex items-center gap-2">
                              ...
                              {echange.type === "ACHAT" ? "Raghif -> Liegois" : "Liegois -> Raghif"}
                            </div>
                          </td>
              ...
              <div className="grid gap-2">
                ...
                <Select value={type} onValueChange={(value: "ACHAT" | "VENTE") => setType(value)}>
                  ...
                  <SelectContent className="bg-card">
                    <SelectItem value="ACHAT">Raghif donne à Liegois</SelectItem>
                    <SelectItem value="VENTE">Liegois donne à Raghif</SelectItem>
                  </SelectContent>
                </Select>
              </div>
